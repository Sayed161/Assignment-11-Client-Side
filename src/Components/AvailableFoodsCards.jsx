...
const AvailableFoodsCards = ({card}) => {
  ...
  return (
	...
	<div>
		<img src="https://t4.ftcdn.net/jpg/06/39/84/27/360_F_639842716_DHKbdGVGjYkHQ2k5VH6KECJoxGt3Egkc.jpg" alt="" className="object-cover w-full mb-4 h-60 sm:h-96 dark:bg-gray-500" />
